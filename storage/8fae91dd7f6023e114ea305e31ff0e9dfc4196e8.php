...
<div class="slide-home-01">
    <div class="response-product product-list-owl owl-slick equal-container better-height"
        ...
        <div class="slide-wrap">
            <img src="<?php echo e(FE_URL); ?>images/slide2222.jpg" alt="image">
        ...
        <div class="slide-wrap">
            <img src="<?php echo e(FE_URL); ?>images/slide11new.jpg" alt="image">
            <div class="slide-info">
                <div class="container">
                    <div class="slide-inner">
                        <h5>Best Selling</h5>
                        <h1><span>Glamorous</span></h1>
                        <h2>& Cute</h2>
                        <a href="#">Shop now</a>
                    </div>
                </div>
        ...
        <div class="slide-wrap">
            <img src="<?php echo e(FE_URL); ?>images/slide333.jpg" alt="image">
            <div class="slide-info">
                <div class="container">
                    <div class="slide-inner">
...
</div><?php /**PATH C:\xampp\htdocs\OOP_MVC\mvc\app\views/layouts-fe/header.blade.php ENDPATH**/ ?>