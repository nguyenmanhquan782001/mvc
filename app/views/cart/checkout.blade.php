                    ...
                    <div class="page-main-content">
                        <div class="akasha">
                            ...
                            <form  method="post" class="checkout akasha-checkout"
                                  action="{{BASE_ULR . 'save-checkout'}}" enctype="multipart/form-data"
                                    ...
                                    <table class="shop_table akasha-checkout-review-order-table">
                                        ...
                                        <tr class="cart_item">
                                            <td class="product-name">
                                               {{$product->name}} <strong class="product-quantity">×
                                                    {{$_SESSION['cart'][$product->id]['qty']}} </strong></td>
                                            <td class="product-total">
                                            <span class="akasha-Price-amount amount"><span
                                                        class="akasha-Price-currencySymbol">$</span>{{number_format($product->price*$_SESSION['cart'][$product->id]['qty'])}}</span></td>
                                        </tr>
                                        <?php
                                        ...
                                        <tr class="cart-subtotal">
                                            ...
                                            <td><span class="akasha-Price-amount amount"><span
                                                            class="akasha-Price-currencySymbol">$</span>{{$totalPrice}}</span></td>
                                        </tr>
                                        <tr class="order-total">
                                            <th>Total</th>
                                            <td><strong><span class="akasha-Price-amount amount"><span
                                                                class="akasha-Price-currencySymbol">$</span>{{$totalPrice}}</span></strong>
                                            </td>
                                        </tr>
                                        </tfoot>
                                    </table>
