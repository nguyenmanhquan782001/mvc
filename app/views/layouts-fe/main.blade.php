...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{FE_URL}}images/favicon.png"/>
    ...
    <link rel="stylesheet" type="text/css" href="{{FE_URL}}css/bootstrap.min.css"/>
    <link rel="stylesheet" type="text/css" href="{{FE_URL}}css/animate.css"/>
    <link rel="stylesheet" type="text/css" href="{{FE_URL}}css/bootstrap.min.css"/>
    <link rel="stylesheet" type="text/css" href="{{FE_URL}}css/chosen.min.css"/>
    <link rel="stylesheet" type="text/css" href="{{FE_URL}}css/font-awesome.min.css"/>
    <link rel="stylesheet" type="text/css" href="{{FE_URL}}css/jquery.scrollbar.css"/>
    <link rel="stylesheet" type="text/css" href="{{FE_URL}}css/lightbox.min.css"/>
    <link rel="stylesheet" type="text/css" href="{{FE_URL}}css/magnific-popup.css"/>
    <link rel="stylesheet" type="text/css" href="{{FE_URL}}css/slick.min.css"/>
    <link rel="stylesheet" type="text/css" href="{{FE_URL}}fonts/flaticon.css"/>
    <link rel="stylesheet" type="text/css" href="{{FE_URL}}css/megamenu.css"/>
    <link rel="stylesheet" type="text/css" href="{{FE_URL}}css/dreaming-attribute.css"/>
    <link rel="stylesheet" type="text/css" href="{{FE_URL}}css/style.css"/>
...
<header id="header" class="header style-02 header-dark header-transparent header-sticky">
                ...
                <div class="header-middle-inner">
                    ...
                    <div class="header-logo-nav">
                        <div class="header-logo">
                            <a href="{{BASE_ULR}}"><img alt="Akasha" src="{{FE_URL}}images/logo.png"
                                                        class="logo"></a></div>
  ...
  @foreach( $categories as $category)
                                <li id="menu-item-230"
                                    ...
                                    <a class="akasha-menu-item-title" title="Home" href="{{BASE_ULR}}product/{{$category->id}}">{{$category->cate_name}}</a>
                                </li>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        @if(isset($_SESSION[AUTH]))
                                            <li class="menu-item akasha-MyAccount-navigation-link akasha-MyAccount-navigation-link--edit-account">
                                                <a style="font-size: 10px;" href="">{{$_SESSION[AUTH]['name']}}</a>
                                            </li>
                                        <li class="menu-item akasha-MyAccount-navigation-link akasha-MyAccount-navigation-link--customer-logout">
                                            <a href="{{BASE_ULR ."logout"}}">Logout</a>
                                        </li>

                                        @else
                                            <li class="menu-item akasha-MyAccount-navigation-link akasha-MyAccount-navigation-link--edit-account">
                                                <a href="{{BASE_ULR."res"}}">Đăng kí</a>
                                            </li>
                                            <li class="menu-item akasha-MyAccount-navigation-link akasha-MyAccount-navigation-link--customer-logout">
                                                <a href="{{BASE_ULR ."login"}}">Login</a>
                                            </li>
                                        @endif
                                    </ul>
...
{{--                                    <div class="shopcart-dropdown block-cart-link" data-akasha="akasha-dropdown">--}}
                                        <a class="block-link link-dropdown" href="{{BASE_ULR . "cart"}}">
...
{{--                                    </div>--}}
    ...
    <div class="header-mobile">
        ...
        <div class="header-mobile-mid">
            <div class="header-logo">
                <a href="index-2.html"><img alt="Akasha" src="{{FE_URL}}images/logo.png" class="logo"></a>
            </div>
        </div>
                            ...
                            <div class="widget_shopping_cart_content">
                                ...
                                <ul class="akasha-mini-cart cart_list product_list_widget">
                                    <li class="akasha-mini-cart-item mini_cart_item">
                                        ...
                                        <a href="#">
                                            <img src="{{FE_URL}}images/apro134-1-600x778.jpg"
                                    ...
                                    <li class="akasha-mini-cart-item mini_cart_item">
                                        <a href="#" class="remove remove_from_cart_button">×</a>
                                        <a href="#">
                                            <img src="{{FE_URL}}images/apro1113-600x778.jpg"
                                                 class="attachment-akasha_thumbnail size-akasha_thumbnail"
                                    ...
                                    <li class="akasha-mini-cart-item mini_cart_item">
                                        <a href="#" class="remove remove_from_cart_button">×</a>
                                        <a href="#">
                                            <img src="{{FE_URL}}images/apro201-1-600x778.jpg"
                                                 class="attachment-akasha_thumbnail size-akasha_thumbnail"
